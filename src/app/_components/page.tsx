...
// Server Component que busca dados via TRPC e renderiza o perfil no estilo Pinterest.
    ...
    <div className="mx-auto max-w-5xl py-10 px-4 sm:px-6 lg:px-8">
      ...
      <header className="flex flex-col items-center pb-6 mb-8 text-center">
        ...
        <div className="w-28 h-28 sm:w-40 sm:h-40 flex-shrink-0 mb-4">
          <img
            src={profileImage || "/default-profile.png"} // Usa imagem padrão se profileImage for nula
            alt="Foto de Perfil"
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          ...
          {/* CORREÇÃO DO LOOP: Verifica se há receitas e mapeia */}
          {recipes && recipes.length > 0 ? (
            ...
            // Mensagem de fallback se não houver receitas
             <p className="col-span-4 text-center text-gray-500 py-10">Nenhuma receita encontrada. Comece a cozinhar!</p>
          )}
